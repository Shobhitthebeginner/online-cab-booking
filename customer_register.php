...
<div class="col-md-6 col-md-offset-3">
    <div class="panel panel-login">
        <div class="panel-heading">
            ...
            <div class="col-xs-6">
                <a href="customer_register.php" class="active" id="">Register</a>  
            </div>
            ...
            <div class="panel-body">
                <div class="col-lg-12" >
                    <form id="register-form" method="post" role="form">
                        ...
                        <div class="form-group">
                            <input type="text" name="last_name" id="username" tabindex="1" class="form-control" placeholder="last name" value="" required >
                        </div>
                        ...
                        <div class="form-group">
                            <input type="tel" name="mobile" id="username" tabindex="2" class="form-control" placeholder="Mobile Number" value="" required >
                        </div>
                        
                    <div class="form-group">
                            <input type="number" name="age" id="age" tabindex="2" class="form-control" placeholder="age" value="" required >
                        </div>
